...
class LinkedBinaryTree(BinaryTree):
    ...
    class _Node():
        ...
        def __init__(seld,element,parent=None,left=None,right=None):
    ...
    class Position(BinaryTree.Position):
        ...
        def __init__(self,container,node):
            ...
            self._container = container # what is this?
            self._node = node
    ...
    def left(self,p):
        """Return the Position of p's left child node or None"""
        node = self._validate(p)  
        return self._make_position(node._left)

    def right(self,p):
        """Return the Position of p's right child node or None"""
        node = self._validate(p)  
    ...
    def _add_root(self,e):
        """Place element eat the root of an empty tree and return the new Position
